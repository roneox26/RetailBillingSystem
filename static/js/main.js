...
function checkout() {
    ...
    fetch('/api/transactions', {
        ...
        body: JSON.stringify({
            ...
            patient_name: document.getElementById('patientName') ? document.getElementById('patientName').value : '',
            doctor_name: document.getElementById('doctorName') ? document.getElementById('doctorName').value : ''
        })
    })
